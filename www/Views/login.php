    ...
    <section class="login-hero">
        ...
        <div class="login-hero-body">
            ...
            <p class="login-hero-lead">
                Retrouvez vos comptes, vos catégories et vos projections. Tout est resté exactement à sa place, prêt à être repris.
            </p>
        </div>
    </section>
        ...
        <form method="POST" action="/signinUser" class="login-fields">
            ...
            <div class="login-field">
                <div class="login-field-row">
                    ...
                    <a href="/resetPassword" class="login-field-forgot">MOT DE PASSE OUBLIÉ ?</a>
                </div>
